...
public class CodingbatFunctional2 {
    public static void main(String[] args) {
        ...
        List<Integer> ln = new ArrayList<>(Arrays.asList(1, 29, 14, 569, 4, 4));
        List<Integer> lnn = new ArrayList<>(Arrays.asList(1, -3, 0, 22, 3, 564));
        List<String> ls = new ArrayList<>(
                Arrays.asList("hi", "Hello", "ABC", "xyz", "cy"));

        CodingbatFunctional2 cb = new CodingbatFunctional2();
        System.out.println(cb.noNeg(lnn));
        System.out.println(cb.no9(ln));
        System.out.println(cb.noTeen(ln));
        System.out.println(cb.noZ(ls));
        System.out.println(cb.noLong(ls));
        System.out.println(cb.no34(ls));
        System.out.println(cb.noYY(ls));
        System.out.println(cb.two2(ln));
        System.out.println(cb.square56(ln));
    }
